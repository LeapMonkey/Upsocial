    ...
    return (
        <NavigationContainer >
            ...
            >
                ...
                <Drawer.Screen name='Add a Video' component={uploadingViddeo} options={{ headerTintColor: "#fff", headerStyle: { backgroundColor: "#5E1DA6" }, headerTitleStyle: { color: "#fff", fontSize: 24 } }} />
